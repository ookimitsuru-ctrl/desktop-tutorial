...
(function (H) {
  ...
  H.MILESTONES = [
    ...
    { id: 'volcano', r: 6.2, title: '火山が三つ',
      log: '火山が三つ。ふたつは火がついていて、朝ごはんを温めるのにちょうどいい。' },
    ...
    { id: 'sprout', r: 13.2, title: 'バオバブの芽', need: { life: 3 },
      log: 'バオバブの芽が出た。小さいうちに抜かないと、星は割れてしまう。' },
    { id: 'rose', r: 16.5, title: '一輪のバラ',
      need: { life: 6 },
      log: 'どこからか種がとんできて、一輪のバラが咲いた。ガラスの覆いをかけてやる。' },
    ...
    { id: 'bench', r: 28.5, title: '夕日を見る椅子',
      log: '椅子をすこし動かすだけで、いつでも日の入りが見られる。' },
    { id: 'prince', r: 34.5, title: '王子さまが来た',
      log: '金色の髪の小さな人が、渡り鳥につかまってやって来た。しばらく住むらしい。' },
    { id: 'named', r: 42.0, title: '星に名前がついた',
      log: '地球の望遠鏡からも見えるようになった。標柱を立てて、名前を彫る。' }
  ];
